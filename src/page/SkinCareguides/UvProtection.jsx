  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Find the product related to UV Protection
        const uvProduct = data.find((item) => item.slug === "uv-protection");
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              {product.signs && (
                <>
                  <h3 className="text-2xl font-semibold mt-6 mb-3">Details</h3>
                  <div
              ...
              <p className="text-gray-700 mb-4">
                Recommended product: <strong>CEEN Broad Spectrum SPF 50</strong>{" "}
                for full protection against UVA and UVB rays.
              </p>
            </div>
