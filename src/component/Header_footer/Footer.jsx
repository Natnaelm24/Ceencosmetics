    ...
    <footer className="bg-[#e5e2d7] text-black pt-12">
      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p className="text-black mb-4">Discover your natural glow with our premium skincare and cosmetics. Cruelty-free & effective.</p>
          <div className="flex space-x-3">
            {[Facebook, Instagram, Twitter, Youtube].map((Icon, i) => (
              <a key={i} href="#" className="bg-[#855d14] text-[#e5e2d7] p-2 rounded-full hover:bg-[#ffffff] hover:text-[#855d14] transition-colors">
                <Icon size={18} />
              </a>
            ))}
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-black">
            {['Skincare', 'Makeup', 'Body Care', 'Fragrance', 'New Arrivals', 'Best Sellers'].map(link => (
              <li key={link}>
                <a href="#" className="hover:text-[#ffffff] transition-colors">{link}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-black">
            {['Contact Us', 'Shipping Info', 'Returns', 'FAQ', 'Privacy Policy', 'Terms of Service'].map(link => (
              <li key={link}>
                <a href="#" className="hover:text-[#ffffff] transition-colors">{link}</a>
              </li>
            ))}
        ...
        <div>
          ...
          <div className="space-y-3 mb-4 text-black">
            <div className="flex items-center space-x-2">
              ...
              <span>support@luminabeauty.com</span>
            </div>
            <div className="flex items-center space-x-2">
          ...
          <div className="flex">
            <input type="email" placeholder="Your email" className="flex-1 px-3 py-2 bg-[#7a5212] border border-[#e5e2d7] text-white rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#e5e2d7]" />
            <button className="bg-[#ffffff] hover:bg-[#e5e2d7] text-[#855d14] px-4 py-2 rounded-r-lg transition-colors">Join</button>
          </div>
        </div>
      ...
      <div className="border-t border-[#855d14]">
        <div className="container mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#e5e2d7] text-sm mb-4 md:mb-0">© 2024 CEEN. All rights reserved.</p>
